      ...
      <main className="main" id="areaB">
        <Routes>
          ...
          <Route
            path="/projects/:id"
            element={
              <FormTabs addProject={addProject} deleteProject={deleteProject} />
            }
          />
          <Route
            path="/projects/new"
          ...
          <Route
            ...
            element={<FacturasRecibidasList projects={projects} />}
          />
          <Route
            path="/facturas-recibidas/:id"
            element={
              <FacturaRecibidaForm
                addProject={addProject}
                projects={projects}
          ...
          />
          <Route
            path="/facturas-recibidas/new"
            element={<FacturaRecibidaForm addProject={addProject} />}
          />
          <Route
            path="/facturas-emitidas"
            element={<FacturasEmitidasList projects={projects} />}
          />
          <Route
          ...
          <Route
            path="/horas/:id"
            element={<HorasForm addProject={addProject} />}
          />
          <Route
            path="/horas/new"
            element={<HorasForm addProject={addProject} />}
