...
public class ApplicationTest {
    ...
    void deleteProject() throws Exception{
        Project project = projectsRepository.save(new Project("", "Formació y emprendimiento verde","P-Territori", "Fundación biodiversidad", "", "Pendent", "Contracte", "Gran", "ess", "Sep21", "Des21", 1, 1, 1, 1,2, 3, 1, "", null, null));
