...
public class SampleDataLoader {
    ...
    private void cargarDatosDePrueba() {
       ...
       Project projectrecibida1 = new Project("21F011", "Formació en cures", "Formació", "Aj Terrassa", "", "Aprovada", "Contracte", "Petit", "cures", "gen22", "març22", "");
        ...
        Project project1 = new Project("21F010", "Emprendoria i Génere 2022", "Formació", "AJ Montornés Del Vallés", "", "Aprobada", "Contrato", "Mitjant", "Dones", "abr22", "nov22", 1, 1, 1, 1, 1, 1, 1, "", "", "",null,null, null);
        ...
        projectsRepository.saveAll(
                List.of(
                        ...
                        project3,
                        project4,
                        new Project("", "Singulars Cooperative Joves", "Formació", "LabCoop", "", "Aprovada", "Subvensio", "Gran", "joves", "Nov21", "Septembre-22", 1, 1, 1, 2, 3, 4, 1,"", "", "", null, null, null),
                        new Project("", "Empendoria verda", "P-Territori", "Espai ambiental", "", "Pendent", "Contracte", "Mini", "ess", "", "", 1, 1, 1, 1, 1, 1, 1, "", "", "", null, null, null),
                        new Project("", "Formació y emprendimiento verde", "P-Territori", "Fundación biodiversitat", "", "Pendent", "Contracte", "Gran", "ess", "Sep21", "Des21", 1, 1, 1, 1, 1, 1, 1, "", "", "", null, null, null),
                        new Project("", "Juntes Emprenem amb", "Formació", "LabCoop", "", "Pendent", "Subvenció", "Mitjant", "dones", "Oct21", "Des21", 1, 1, 1, 1, 2, 1, 3, "", "", "", null, null, null),
                        new Project("", "Escola popular d'economia feminista", "Formació", "Cooperació", "", "Pendent", "Contracte", "petit", "dones", "", "", 1, 1, 1, 1, 1, 1, 1, "", "", "", null, null, null),
                        new Project("22F028", "Que salga de una vez", "formación", "SonLux", " ", "Aprobat", "Contracte", "Mitjant", "Dones", "feb21", "maz22", 1, 1, 1, 1, 1, 1, 1, "", "", "", null, null, null))
        );
